...
通过 `aclCreateTensor` 创建 `aclTensor` 时支持的数据类型。
...
- **推理**：FLOAT16, BF16, INT8, INT4
- **训练**：FLOAT32, BF16
- **量化**：INT8, INT4, FLOAT8_E4M3FN, FLOAT8_E8M0
- **A5 新增**：FLOAT8 系列, HIFLOAT8, MXFP8, MXFP4

## 完整类型参考

参见 [acl API（C）](https://hiascend.com/document/redirect/CannCommunityCppApi) 中"数据类型及其操作接口 > aclDataType"

## 来源
- `ops-transformer_AI/docs/zh/context/数据类型.md`
